...
data class CrosshairConfig(
    ...
    val showCenterCross: Boolean = true, // показывать крест в центре круга (CIRCLE)
    val centerCrossSize: Float = 0.2f,  // размер центрального крестика (доля от радиуса): 0.0..0.6
