...
> **Версия:** 1.4.0 | **Дата:** 19 марта 2026 г. | **Min SDK:** 31 (Android 12+)

## 📱 Краткое описание

**Mentality Scope** — полнофункциональное Android-приложение прицел-оверлей (Crosshair Overlay) для мобильных шутеров. Отображает кастомизируемый прицел поверх любых приложений через WindowManager Overlay, работает как Foreground Service, поддерживает AMOLED/Dark/Light/System темы, мультиязычность (RU/EN) и гибкую настройку конфигураций.
...
- **[BUILD_INSTRUCTIONS.md](BUILD_INSTRUCTIONS.md)** — сборка, JAVA_HOME, типичные ошибки
- **[ARCHITECTURE.md](ARCHITECTURE.md)** — архитектура MVVM, data flow, компоненты
...
3. **Язык** — Системный / Русский / English  
